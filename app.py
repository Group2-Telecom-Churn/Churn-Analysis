...
def initialize_application():
    # Initialize the database only once per Streamlit process.
    initialize_database()

    # Load the 70 historical seed customers only when the registry is empty.
    ...
    # Generate historical scans only once per Streamlit process.
    generate_seed_scans(loaded_preprocessor, loaded_model)

    # Return the loaded artifacts for the current application session.
