...
if page == "Dashboard":
    ...
    if "latest_probability" in st.session_state:
        ...
        # Build the profile values required by the recommendation rules.
        recommendation_customer = {
            "Contract": input_data.iloc[0]["Contract"],
            "InternetService": input_data.iloc[0]["InternetService"],
            "OnlineSecurity": input_data.iloc[0]["OnlineSecurity"],
            "TechSupport": input_data.iloc[0]["TechSupport"],
            "PaymentMethod": input_data.iloc[0]["PaymentMethod"],
            "MonthlyCharges": input_data.iloc[0]["MonthlyCharges"],
            "tenure": input_data.iloc[0]["tenure"],
        }
